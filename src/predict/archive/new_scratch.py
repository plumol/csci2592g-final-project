...
def run_model(g, f, filtered_df, epochs=25, batch_size=1024):
    ...
    gene_name = ["Hbb-y" for i in range(filtered_df.shape[0])]
...
def set_up_graph(data_path, gene):
    ...
    try:
        ...
        with open('myo1b_processed_data', 'rb') as file:
...
g, f, filtered_df = set_up_graph(data_path, "Myo1b")
result_df = run_model(g, f, filtered_df, epochs=7, batch_size=1024)
